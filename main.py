...
class Game:
    def __init__(self, fps=60):
        ...
        self.analyse = True # True or False
        ...
        # Second basket
        self.points.append(PointCollider(792, 171))
        self.points.append(PointCollider(789, 171))
        self.points.append(PointCollider(787, 173))
        self.points.append(PointCollider(786, 176))
        self.points.append(PointCollider(786, 179))
        self.points.append(PointCollider(786, 181))
        self.points.append(PointCollider(784, 184))
        self.points.append(PointCollider(784, 188))
        self.points.append(PointCollider(783, 191))
        self.points.append(PointCollider(782, 194))
        self.points.append(PointCollider(782, 197))
        self.points.append(PointCollider(782, 201))
        self.points.append(PointCollider(781, 204))
        self.points.append(PointCollider(780, 209))
        self.points.append(PointCollider(780, 212))
        self.points.append(PointCollider(779, 216))
        self.points.append(PointCollider(779, 220))
        self.points.append(PointCollider(779, 223))
        self.points.append(PointCollider(779, 226))
        self.points.append(PointCollider(779, 230))
        self.points.append(PointCollider(789, 168))
        self.points.append(PointCollider(788, 164))
        self.points.append(PointCollider(792, 164))
        self.points.append(PointCollider(726, 172))
        self.points.append(PointCollider(726, 168))
        self.points.append(PointCollider(726, 164))
        self.points.append(PointCollider(723, 164))
        self.points.append(PointCollider(721, 164))
        self.points.append(PointCollider(721, 168))
        self.points.append(PointCollider(721, 172))
        self.points.append(PointCollider(724, 172))
        self.points.append(PointCollider(728, 174))
        self.points.append(PointCollider(728, 176))
        self.points.append(PointCollider(728, 179))
        self.points.append(PointCollider(729, 183))
        self.points.append(PointCollider(731, 186))
        self.points.append(PointCollider(730, 188))
        self.points.append(PointCollider(731, 191))
        self.points.append(PointCollider(732, 195))
        self.points.append(PointCollider(732, 199))
        self.points.append(PointCollider(733, 202))
        self.points.append(PointCollider(733, 206))
        self.points.append(PointCollider(734, 209))
        self.points.append(PointCollider(734, 213))
        self.points.append(PointCollider(734, 217))
        self.points.append(PointCollider(734, 221))
        self.points.append(PointCollider(735, 225))
        self.points.append(PointCollider(735, 228))
        self.points.append(PointCollider(735, 223))
